 ...
 * @author mthoming
 */
public class LookupByModelTest {
    
    public LookupByModelTest() {
    }

    /**
     * Test of handleIt method, of class LookupByModel.
     */
    @Test
    public void testHandleIt() {
        System.out.println("handleIt");
        HashMap<String, Object> dataMap = null;
        LookupByModel instance = new LookupByModel();
        instance.handleIt(dataMap);
        // TODO review the generated test code and remove the default call to fail.
       
        Session s = connection.Controller.getSessionFactory().openSession(); 
        String HQL = "from Automobile where model = 'Corvette' order by year desc";
